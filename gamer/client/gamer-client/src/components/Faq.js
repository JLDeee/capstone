...
function Faq(){
    ...
    <div className="container">
       ...
       <div className="questions">
        ...
        <div className='q2'>
            <h3>How old do I have to be to use Gamers' Guild?</h3>
        ...
        <div className='q3'>
            <h3>What consoles/platforms is Gamers' Guild catered towards?</h3>
        ...
        <div className='q4'>
            <h3>Is there a limit to how many posts I can make in the Community Forum?</h3>
        ...
        <div className='q5'>
            <h3>How does the Duo Finder Work?</h3>
        ...
        <div className='q6'>
            <h3>What do I do if another user is harassing me?</h3>
        ...
        <div className='q8'>
            <h3>What are your favorite games?</h3>
